...
type ICreateWishlistItemSchema = zodInfer<typeof CreateWishlistItemSchema>;
type IGetWishlistQuerySchema = zodInfer<typeof GetWishlistQuerySchema>;
type IGetWishlistItemSchema = zodInfer<typeof GetWishlistItemSchema>;
type IDeleteWishlistItemSchema = zodInfer<typeof DeleteWishlistItemSchema>;
type IWishlistItemResponseSchema = zodInfer<typeof WishlistItemResponseSchema>;
type IWishlistListResponseSchema = zodInfer<typeof WishlistListResponseSchema>;

// Export types
export type {
    ICreateWishlistItemSchema,
    IGetWishlistQuerySchema,
    IGetWishlistItemSchema,
    IDeleteWishlistItemSchema,
    IWishlistItemResponseSchema,
    IWishlistListResponseSchema,
};
