...
export default function AboutPage() {
  return (
    <div className="max-w-[1200px] min-h-screen flex flex-col mx-auto pt-26 pb-14 px-8 md:px-4 sm:px-2 bg-white dark:bg-black">
      <h1 className="text-center text-5xl md:text-2xl font-medium mb-9 md:mb-9 text-black dark:text-white font-serif">Brand Story</h1>

      <section className="mb-12 md:mb-8">
        <h2 className="text-xl md:text-lg font-semibold mb-5 md:mb-3 text-black dark:text-white">The Beginning</h2>
      ...
      <section className="mb-12 md:mb-8">
        <h2 className="text-xl md:text-lg font-semibold mb-5 md:mb-3 text-black dark:text-white">Our Philosophy</h2>
        <p className="text-base md:text-sm leading-relaxed text-gray-700 dark:text-gray-300 text-justify m-0">
      ...
      <section className="mb-12 md:mb-8">
        <h2 className="text-xl md:text-lg font-semibold mb-5 md:mb-3 text-black dark:text-white">Our Promise</h2>
        <p className="text-base md:text-sm leading-relaxed text-gray-700 dark:text-gray-300 text-justify m-0">
